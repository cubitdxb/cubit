...
class CiscoReportWizard(models.TransientModel):
    _name='cisco.report.wizard'
    _description='Cisco Report'
    ...
    def action_print_xls(self):
        ...
        return self.env.ref('cubit_crm_reports.action_cisco_report_report_xls').sudo().report_action(self,data=data)
