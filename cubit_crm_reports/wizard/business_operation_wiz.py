...
class BusinessOperationWizard(models.TransientModel):
    _name='business.operation.wizard'
    _description='Business Operation Report'
    ...
    def action_print_xls(self):
        ...
        return self.env.ref('cubit_crm_reports.action_business_operation_report_xls').sudo().report_action(self,data=data)
