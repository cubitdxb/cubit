...
class ProjectTrackerWizard(models.TransientModel):
    ...
    def action_print_xls(self):
        ...
        return self.env.ref('cubit_crm_reports.action_project_tracker_report_xls').sudo().report_action(self,data=data)
