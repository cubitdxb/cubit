...
class ProjectTrackerXlsx(models.AbstractModel):
    _name = 'report.cubit_crm_reports.report_pro_track_xls'
    ...
    def generate_xlsx_report(self,workbook,data,complaints):
        ...
        if data:
            print(data, 'dataaaaaaaaaaaaaaaaaaaaaaaaaaaa')
            ...
            sheet = workbook.add_worksheet('Project Tracker Report')
            ...
            sheet.merge_range('B2:L2', 'Project Tracker Report', merge_format)
            ...
            sheet.write(row, column+10, 'Latest Remarks', bold)
            ...
            if projects:
                ...
                for service in projects:
                  ...
                  #  sheet.write(row,column+2, i.create_date.strftime('%d/%m/%Y %H:%M:%S') if i.create_date else '')
                    ...
                    sheet.write(row,column+10, tools.html2plaintext(service.description) if service.description else '')
